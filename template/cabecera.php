...
<body>
    ...
    <div class="preloader">
        <div class="preloader-logo">
            <a class="brand" href="index.html">
                <img class="brand-logo-dark" src="images/White Minimalist Destination Travel Agency Logo.png" alt="" width="177" height="59"/>
            </a>
        </div>
    ...
    <div class="page">
        <!-- Page Header-->
        <a class="banner banner-top" href="https://www.templatemonster.com/website-templates/monstroid2.html" target="_blank">
            <img src="" alt="" max-width="0" max-height="0"/>
        </a>
        <!-- Page Header-->
