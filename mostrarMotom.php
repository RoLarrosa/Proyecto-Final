...
$validar = "SELECT u.usuario, p.perfil, pu.publicacion FROM usuario u JOIN perfil p ON u.id_perfil = p.id_perfil JOIN publicaciones pu ON p.id_perfil = pu.id_perfil AND u.id_usuario = pu.id_usuario WHERE u.id_perfil = 3";
